const investers = [
  {
    ...
    name: "Miguel Silva",
    avatar:
      "https://d64gsuwffb70l.cloudfront.net/691bae6041555f05a5561a30_1763421916644_96144368.webp",
    city: "Lisboa",
    country: "Portugal",
    role: "Investor",
    partners: [
    ...
    description:
      "Experienced investor focused on early-stage deep tech and aerospace opportunities.",
    projectInfo: {
      title: "Navis Aerium - Advanced UAV systems",
      summary:
        "Developing lightweight, efficient UAVs for maritime inspection and logistics.",
      category: "Aerospace",
      stage: "Prototype",
    ...
    videoPitch: "https://www.youtube.com/embed/ZVnjOPwW4ZA",
    presentationVideos: [
      "https://www.youtube.com/embed/ZVnjOPwW4ZA",
      "https://www.youtube.com/embed/ZVnjOPwW4ZA",
    ],
    docs: [
      { name: "Technical Specification", url: undefined },
      { name: "Presentation Sheet", url: undefined },
    ],
  },

  {
    ...
    name: "Sofia Martinez",
    avatar:
      "https://d64gsuwffb70l.cloudfront.net/691bae6041555f05a5561a30_1763421918534_e38edc79.webp",
    city: "Madrid",
    country: "Spain",
    role: "Angel Investor",
    partners: [
    ...
    description:
      "Serial entrepreneur and angel investor focusing on SaaS and fintech scaling.",
    projectInfo: {
      title: "FinFlow Payments Platform",
      summary:
        "Real-time payment orchestration for SMBs with advanced reconciliation.",
      category: "Fintech",
      stage: "MVP",
    ...
    docs: [
      { name: "Technical Specification", url: undefined },
      { name: "Investor Deck", url: undefined },
    ],
  },

  {
    ...
    name: "Lucas Dubois",
    avatar:
      "https://d64gsuwffb70l.cloudfront.net/691bae6041555f05a5561a30_1763421920458_0136a615.webp",
    city: "Paris",
    country: "France",
    role: "VC",
    partners: [
    ...
    description:
      "Logistics and smart supply-chain investments, preferring B2B startups with traction.",
    projectInfo: {
      title: "SmartLogix - Supply Chain AI",
      summary: "Predictive routing and warehouse optimization using AI.",
      category: "Logistics",
      stage: "Scale",
...

  {
    ...
    name: "Emma Schmidt",
    avatar:
      "https://d64gsuwffb70l.cloudfront.net/691bae6041555f05a5561a30_1763421922322_3dcfc0af.webp",
    city: "Berlin",
    country: "Germany",
    ...
    description:
      "AI investor with emphasis on vision systems and healthcare applications.",
    projectInfo: {
      title: "VisionAI Medical Imaging",
      summary:
        "Computer vision for automated diagnostic assistance in radiology.",
      category: "HealthTech",
      stage: "Clinical",
    ...
    docs: [
      { name: "Clinical Datasheet", url: undefined },
      { name: "Investor Presentation", url: undefined },
    ],
  },

  {
    ...
    avatar:
      "https://d64gsuwffb70l.cloudfront.net/691bae6041555f05a5561a30_1763421924213_f44cbbce.webp",
    city: "Rome",
    country: "Italy",
    ...
    description:
      "Investor focused on clean energy and industrial IoT projects.",
    projectInfo: {
      title: "GenTech Energy Storage",
      summary: "Next-gen battery management and recycling solutions.",
