      ...
      <div className="flex items-start gap-2 flex-col">
        ...
        <div className='flex gap-4 w-full pr-2'>
          <div className='flex flex-col items-center'>
            <img src={avatar ?? companyLogo} alt={name} className="w-24 h-24 -mt-8 ml-2 rounded-full object-cover border-4 border-white shadow-2xl" />
            <h3 className="ml-4 text-sm font-extrabold text-[#0a3d5c]">{name}</h3>
          </div>
          <div className='flex flex-1 flex-col border-gray-200 border rounded-md'>
            <div className="ml-1 text-[12px] text-[#0a3d5c] font-extrabold">INVESTMENT PORTFOLIO</div>
            <div className="ml-1 text-[10px] text-[#0a3d5c]">OVERVIEW OF VENTURE CAPITAL HOLDINGS</div>
          </div>
        </div>
      </div>
